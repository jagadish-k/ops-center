...
const SYSTEM_ROLES: { name: string; description: string }[] = [
  {
    name: 'superadmin',
    description:
      'Global controller; bypasses tenant scoping. Granted via users.global_role.',
  },
  { name: 'admin', description: 'Control Room operator scoped to one tenant.' },
  {
    name: 'manager',
    description:
      'Tenant-scoped coordinator; can reassign staff and create dispatches.',
  },
...
const TENANTS = [
  {
    ...
    healthScore: 98,
    notes: 'Premium enterprise tenant. Main ops center for big events.',
    bboxMinLat: 40.8113,
    bboxMaxLat: 40.8143,
    bboxMinLng: -74.0757,
    bboxMaxLng: -74.0727,
...
const DEV_TENANT_ACCESS_PERIODS = [
  {
    ...
    notes: 'Summer Concert Series Ops',
  },
  {
    ...
    notes: 'Esports Tournament Setup',
  },
];

const DEV_TENANT_CONTACTS = [
  {
    id: '22222222-2222-4222-a222-111111111111',
    tenantId: 'tenant_metlife_ops',
    name: 'Alice Manager',
    email: 'alice@metlife-ops.test',
    phone: '+15550100',
    role: 'SPOC',
  },
  {
...
const DEV_INCIDENTS = [
  // ── MetLife — Ground floor incidents ──
  {
    ...
    rawText:
      'Section 112 — crowd surge against the perimeter railing. Multiple patrons at risk of crush injury.',
    category: 'CROWD',
    severity: 'CRITICAL',
    locationSector: 'ZONE-B',
    coordX: 610,
    coordY: 410,
    actionRequired: 'Deploy riot line + triage team immediately.',
  },
  {
    id: 'inc_seed_003',
    tenantId: 'tenant_metlife_ops',
    ...
    rawText:
      'Unresponsive male near Gate C, possible cardiac event. AED requested.',
    category: 'MEDICAL',
    severity: 'HIGH',
  ...
  },
  {
    ...
    rawText:
      'Overflowing restroom fixture causing standing water in corridor. Slip hazard.',
    category: 'FACILITIES',
    severity: 'MEDIUM',
    locationSector: 'ZONE-E',
    coordX: 720,
    coordY: 350,
    actionRequired: 'Facilities crew + wet-floor signage.',
  },
  {
    id: 'inc_seed_006',
    tenantId: 'tenant_metlife_ops',
    ...
    coordX: 280,
    coordY: 540,
    actionRequired: 'Resolved — patron handed to PD.',
  },
  {
    id: 'inc_seed_010',
    tenantId: 'tenant_metlife_ops',
    ...
    rawText:
      'Structural crack observed in railing at Section 112 upper level. Immediate evacuation risk.',
    category: 'FACILITIES',
    severity: 'CRITICAL',
    locationSector: 'ZONE-A',
    coordX: 380,
    coordY: 310,
    actionRequired: 'Evacuate Section 112 upper. Engineering assessment.',
  },
  // ── MetLife — Level 200 incidents ──
  {
    ...
    rawText:
      'Physical altercation in upper deck, Section 308. Two individuals, no weapons observed.',
    category: 'SECURITY',
    severity: 'HIGH',
    locationSector: 'ZONE-A',
    coordX: 300,
  ...
  },
  {
    ...
    rawText:
      'Patron collapsed in vomitory Section 312. Delta Medical en route.',
    category: 'MEDICAL',
    severity: 'HIGH',
    locationSector: 'ZONE-B',
    coordX: 700,
    coordY: 400,
    actionRequired: 'Delta Medical dispatched. AED on standby.',
  },
  {
    id: 'inc_seed_008',
    tenantId: 'tenant_metlife_ops',
    ...
    rawText:
      'Spilled beverages in concourse near Section 300. Multiple spill points.',
    category: 'FACILITIES',
    severity: 'LOW',
    locationSector: 'ZONE-C',
    coordX: 800,
    coordY: 600,
    actionRequired: 'Cleaning crew dispatched.',
  },
  // ── MetLife — Suite level incidents ──
  {
    ...
    rawText:
      'Long concession queues at Suite Lounge causing congestion. Advisory only.',
    category: 'ADVISORY',
    severity: 'LOW',
    locationSector: 'ZONE-A',
    coordX: 500,
    coordY: 300,
    actionRequired: 'Monitor; open auxiliary point if congestion worsens.',
  },
  {
    id: 'inc_seed_009',
    tenantId: 'tenant_metlife_ops',
    ...
    rawText:
      'Lost child reunited with family at Guest Services. No further action needed.',
    category: 'ADVISORY',
    severity: 'LOW',
    locationSector: 'ZONE-A',
    coordX: 400,
  ...
  // ── SoFi Stadium incidents (no floor_id) ──
  {
    ...
    rawText:
      'Unauthorized access attempt at VIP entrance. Individual detained.',
    category: 'SECURITY',
    severity: 'HIGH',
    locationSector: 'ZONE-A',
    coordX: 200,
    coordY: 300,
    actionRequired: 'Security backup to VIP entrance.',
  },
  {
    id: 'inc_sofi_002',
    tenantId: 'tenant_sofi_ops',
    ...
    rawText:
      'Patron experiencing heat exhaustion in Section 215. requesting medical.',
    category: 'MEDICAL',
    severity: 'HIGH',
    locationSector: 'ZONE-B',
    coordX: 650,
    coordY: 500,
    actionRequired: 'Tango Medical dispatched with water + cooling.',
  },
  {
    id: 'inc_sofi_003',
    tenantId: 'tenant_sofi_ops',
    ...
    coordX: 800,
    coordY: 200,
    actionRequired: 'Restock paper towels.',
  },
  // ── Hard Rock Stadium incidents (no floor_id) ──
  {
    ...
    rawText:
      'Fight in parking lot Section D. Multiple individuals. PD requested.',
    category: 'SECURITY',
    severity: 'CRITICAL',
    locationSector: 'ZONE-A',
    coordX: 300,
    coordY: 400,
    actionRequired: 'Police dispatched. Secure perimeter.',
  },
  {
    id: 'inc_hr_002',
    tenantId: 'tenant_hardrock_ops',
    ...
    coordX: 700,
    coordY: 300,
    actionRequired: 'Monitor patron. Transport if needed.',
  },
  {
    id: 'inc_hr_003',
    tenantId: 'tenant_hardrock_ops',
    ...
    coordX: 600,
    coordY: 500,
    actionRequired: 'Deploy wet-floor signage at entrances.',
  },
];
...
export async function seed(db: ReturnType<typeof drizzle>): Promise<void> {
  ...
  console.log('  → Tenant Access Periods...');
  await db
    .insert(tenantAccessPeriodsTable)
    .values(DEV_TENANT_ACCESS_PERIODS)
    .onConflictDoNothing({ target: tenantAccessPeriodsTable.id })
    .execute();

  console.log('  → Tenant Contacts...');
  await db
    .insert(tenantContactsTable)
    .values(DEV_TENANT_CONTACTS)
    .onConflictDoNothing({ target: tenantContactsTable.id })
    .execute();
  ...
  await db
    ...
    .values(
      DEV_USERS.map((u) => ({
        ...
        authProvider: 'phone_otp' as const,
      })),
    )
    .onConflictDoUpdate({
  ...
  for (const inc of DEV_INCIDENTS) {
    const reportedBy = inc.reportedByPhone
      ? (phoneToId.get(inc.reportedByPhone) ?? null)
      : null;
