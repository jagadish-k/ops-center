...
export default function LandingPage() {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      ...
      await fetch(
        'https://script.google.com/macros/s/AKfycbz_placeholder_webhook/exec',
        {
          method: 'POST',
  ...
  return (
    <div className="flex min-h-screen flex-col bg-slate-50 text-slate-900 transition-colors duration-500 dark:bg-slate-950 dark:text-slate-50">
      ...
      <main className="flex-1">
        <section className="relative overflow-hidden pt-32 pb-24 lg:pt-48 lg:pb-32">
          ...
          <div className="relative z-10 mx-auto max-w-7xl px-6 text-center">
            <h1 className="mx-auto max-w-4xl font-mono text-5xl font-black uppercase tracking-tight sm:text-7xl lg:text-8xl">
              ...
              <span className="block bg-linear-to-r from-blue-600 to-indigo-400 bg-clip-text text-transparent dark:from-blue-400 dark:to-indigo-300">
                Unpredictable.
              </span>
            </h1>

            <p className="mx-auto mt-8 max-w-2xl text-lg text-slate-600 sm:text-xl dark:text-slate-400">
              Hardware-accelerated situational awareness for stadiums and
              mega-events. Map assets, dispatch staff, and resolve incidents in
              real-time.
            </p>
        ...
        <section className="border-t border-slate-200 bg-white py-24 dark:border-slate-800 dark:bg-slate-900/20">
          <div className="mx-auto max-w-7xl px-6">
            <div className="mb-16 text-center">
              <h2 className="font-mono text-sm font-black uppercase tracking-widest text-blue-600 dark:text-blue-400">
                Core Engine
              </h2>
              <p className="mt-4 text-3xl font-bold tracking-tight text-slate-900 sm:text-4xl dark:text-slate-100">
            ...
            <div className="grid gap-12 lg:grid-cols-3">
              <div className="flex flex-col gap-4 rounded-2xl border border-slate-200 bg-slate-50 p-8 dark:border-slate-800 dark:bg-slate-950">
                <div className="flex h-12 w-12 items-center justify-center rounded-lg bg-blue-100 text-2xl text-blue-600 dark:bg-blue-900/30 dark:text-blue-400">
                  🗺️
                </div>
                ...
                <p className="text-slate-600 dark:text-slate-400">
                  Hardware-accelerated 60fps canvas tracking thousands of staff
                  members and incidents across a responsive 0-1000 coordinate
                  grid.
                </p>
              </div>
              <div className="flex flex-col gap-4 rounded-2xl border border-slate-200 bg-slate-50 p-8 dark:border-slate-800 dark:bg-slate-950">
                <div className="flex h-12 w-12 items-center justify-center rounded-lg bg-emerald-100 text-2xl text-emerald-600 dark:bg-emerald-900/30 dark:text-emerald-400">
                  ⚡
                </div>
                <h3 className="text-xl font-bold text-slate-900 dark:text-slate-100">
                  Real-Time Dispatch
                ...
                <p className="text-slate-600 dark:text-slate-400">
                  Instantly deploy medical, security, and cleaning staff with
                  single-click triage. Mobile field clients receive updates in
                  milliseconds.
                </p>
              </div>
              <div className="flex flex-col gap-4 rounded-2xl border border-slate-200 bg-slate-50 p-8 dark:border-slate-800 dark:bg-slate-950">
                <div className="flex h-12 w-12 items-center justify-center rounded-lg bg-amber-100 text-2xl text-amber-600 dark:bg-amber-900/30 dark:text-amber-400">
                  🎙️
                </div>
                <h3 className="text-xl font-bold text-slate-900 dark:text-slate-100">
                  Voice Ingestion
                ...
                <p className="text-slate-600 dark:text-slate-400">
                  Field staff can report incidents purely through voice. Natural
                  language processing automatically categorizes and places
        ...
        <section
          id="contact"
          className="border-t border-slate-200 bg-slate-100 py-24 dark:border-slate-800 dark:bg-slate-950/50"
        >
          <div className="mx-auto max-w-3xl px-6 text-center">
            ...
            <p className="mt-4 text-lg text-slate-600 dark:text-slate-400">
              Leave your details below and our deployment team will contact you
              for a technical demo.
            </p>

            <form
              onSubmit={handleSubmit}
              className="mx-auto mt-12 flex flex-col gap-4 text-left"
            >
