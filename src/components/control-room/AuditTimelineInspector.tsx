...
export function AuditTimelineInspector({ isOpen, onClose }: AuditTimelineInspectorProps) {
	...
	const fetchAuditData = useCallback(async () => {
		...
		setError(null);
		try {
			const data = await apiFetch<{ entries: AuditLogEntry[]; verification: VerificationReport }>(
				'/api/audit-ledger',
			);
