  ...
  return (
    <div className="flex h-full flex-col gap-4 p-4">
      ...
      {loading && users === null ? (
        ...
        <div
          data-tour="team-table"
          className="overflow-hidden rounded-xl border border-slate-300 bg-white shadow-sm dark:border-slate-800 dark:bg-slate-900/40"
        >
          <Table>
                ...
                >
                  {(u) => (
                    ...
                    >
                      ...
                      <Table.Cell className="text-slate-800 dark:text-slate-100">
                        {u.fullName}
                      </Table.Cell>
                      <Table.Cell>
...
function CreateStaffDrawer({
  ...
  const specialtyValue =
    useWatch({ control: form.control, name: 'specialty' }) ?? 'security';
  const zoneValue =
    useWatch({ control: form.control, name: 'assignedZone' }) ?? 'ZONE-A';
  ...
  const onSubmit = async (values: CreateStaffForm) => {
    ...
    try {
      ...
      setSubmitError(
        err instanceof ApiError ? err.message : 'Failed to create staff',
      );
    } finally {
      setSubmitting(false);
    }
          ...
          <Drawer.Dialog className="sm:max-w-md rounded-2xl">
            ...
            <Drawer.Body>
              ...
              >
                ...
                <div className="flex flex-col gap-1.5">
                  <TextField isInvalid={!!form.formState.errors.fullName}>
                    <Label className="font-mono text-[10px] uppercase tracking-widest text-slate-600 dark:text-slate-400">
                      Full Name
                    </Label>
                    <Input
                  ...
                  <div className="flex flex-col gap-1.5">
                    ...
                    <Select
                      ...
                      onSelectionChange={(k) =>
                        form.setValue(
                          'specialty',
                          k as CreateStaffForm['specialty'],
                        )
                      }
                    >
                      <Select.Trigger>
                  ...
                  <div className="flex flex-col gap-1.5">
                    ...
                    <Select
                      ...
                      onSelectionChange={(k) =>
                        form.setValue(
                          'assignedZone',
                          k as CreateStaffForm['assignedZone'],
                        )
                      }
                    >
                      <Select.Trigger>
...
interface EditUserMutate {
  (
    ...
    optimisticUpdate: (draft: AdminUser[]) => void,
  ): Promise<boolean>;
}
          ...
          <Drawer.Dialog className="sm:max-w-md rounded-2xl">
            ...
            <Drawer.Body>
              <p className="text-xs text-slate-600 dark:text-slate-400">
                Per-user permission grants (ADR-0011 P1). Additive only — they
                grant capabilities on top of the user&apos;s role. Use sparingly
