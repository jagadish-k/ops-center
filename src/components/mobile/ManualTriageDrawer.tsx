  ...
  [
    {
      ...
      label: 'Security',
      className:
        'border-blue-500 bg-blue-500/10 text-blue-200 hover:bg-blue-500/20',
    },
    {
      id: 'MEDICAL',
      label: 'Medical',
    ...
    },
    {
      ...
      label: 'Crowd',
      className:
        'border-red-500 bg-red-500/10 text-red-200 hover:bg-red-500/20',
    },
    {
      id: 'FACILITIES',
      label: 'Facilities',
...
const SEVERITIES: { id: IncidentSeverity; label: string; className: string }[] =
  [
    ...
    },
    {
      id: 'MEDIUM',
      label: 'Medium',
      className: 'border-yellow-500 bg-yellow-500/15 text-yellow-300',
    },
    {
      id: 'LOW',
      label: 'Low',
      className:
        'border-slate-500 bg-slate-500/15 text-slate-600 dark:text-slate-300',
    },
  ];
  ...
  const submit = async (): Promise<void> => {
    ...
    try {
      ...
      setFeedback({
        kind: 'err',
        text:
          err instanceof Error ? `Failed: ${err.message}` : 'Unknown error.',
      });
    } finally {
      setSubmitting(false);
    }
