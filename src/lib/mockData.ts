...
export const mockIncidents: IncidentReport[] = [
	...
	},
	{
		...
		extractedMetadata: {
			...
			actionRequired: 'Facilities crew + wet-floor signage to Level 2 west restroom.',
		},
	},
	{
		id: 'inc_005',
		...
		extractedMetadata: {
			...
			actionRequired: 'Monitor queue length; open auxiliary point if congestion worsens.',
		},
	},
	{
		id: 'inc_006',
