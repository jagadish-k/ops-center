	...
	floors: [
		{
			...
			pois: [
				{ id: 'gate-a', name: 'Gate A', type: 'entry', x: 150, y: 100, notes: 'Main west entrance' },
				{ id: 'gate-b', name: 'Gate B', type: 'entry', x: 625, y: 100, notes: 'Main south entrance' },
				{ id: 'gate-c', name: 'Gate C', type: 'entry', x: 875, y: 100, notes: 'Main east entrance' },
				{ id: 'exit-1', name: 'Exit 1', type: 'exit', x: 150, y: 900 },
				{ id: 'exit-2', name: 'Exit 2', type: 'exit', x: 875, y: 900 },
				{ id: 'restroom-1w', name: 'Restroom W1', type: 'restroom', x: 200, y: 300 },
				{ id: 'restroom-1e', name: 'Restroom E1', type: 'restroom', x: 850, y: 300 },
				{ id: 'first-aid-1', name: 'First Aid Station', type: 'first_aid', x: 500, y: 250, notes: 'Staffed during events; AED available' },
				{ id: 'first-aid-2', name: 'First Aid South', type: 'first_aid', x: 400, y: 650 },
				{ id: 'concession-1', name: 'Concession 100', type: 'concession', x: 300, y: 200 },
				{ id: 'concession-2', name: 'Concession 200', type: 'concession', x: 750, y: 200 },
				{ id: 'concession-3', name: 'Concession 300', type: 'concession', x: 500, y: 550 },
				{ id: 'security-post-1', name: 'Security Checkpoint A', type: 'security_post', x: 200, y: 150 },
				{ id: 'security-post-2', name: 'Security Checkpoint C', type: 'security_post', x: 850, y: 150 },
				{ id: 'elevator-1', name: 'Elevator Bank 1', type: 'elevator', x: 400, y: 400 },
				{ id: 'elevator-2', name: 'Elevator Bank 2', type: 'elevator', x: 700, y: 400 },
		...
		},
		{
			...
			pois: [
				{ id: 'restroom-2w', name: 'Restroom L2-W', type: 'restroom', x: 200, y: 350 },
				{ id: 'restroom-2e', name: 'Restroom L2-E', type: 'restroom', x: 800, y: 350 },
				{ id: 'first-aid-200', name: 'First Aid L2', type: 'first_aid', x: 500, y: 300 },
				{ id: 'concession-200a', name: 'Concourse 200-A', type: 'concession', x: 300, y: 200 },
				{ id: 'concession-200b', name: 'Concourse 200-B', type: 'concession', x: 700, y: 200 },
				{ id: 'elevator-l2-1', name: 'Elevator L2-1', type: 'elevator', x: 400, y: 400 },
				{ id: 'elevator-l2-2', name: 'Elevator L2-2', type: 'elevator', x: 700, y: 400 },
				{ id: 'vomitory-201', name: 'Vomitory 201', type: 'vomitory', x: 250, y: 150 },
				{ id: 'vomitory-250', name: 'Vomitory 250', type: 'vomitory', x: 750, y: 150 },
			],
		},
		{
			id: 'suite-level',
			...
			pois: [
				{ id: 'suite-lounge', name: 'Suite Lounge', type: 'concession', x: 500, y: 300 },
				{ id: 'elevator-suite', name: 'Elevator Suite', type: 'elevator', x: 500, y: 450 },
				{ id: 'restroom-suite', name: 'Restroom Suite', type: 'restroom', x: 300, y: 350 },
			],
		},
	],
};
