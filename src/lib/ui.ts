...
export function tierBadge(tier: InfoTier): BadgeStyle {
	switch (tier) {
		case 1:
			return { className: 'border-red-500 bg-red-500/15 text-red-400', hex: '#ef4444', label: 'T1' };
		case 2:
			return {
...
export function severityBadge(severity: IncidentSeverity): BadgeStyle {
	switch (severity) {
		case 'CRITICAL':
			return { className: 'border-red-500 bg-red-500/15 text-red-400', hex: '#ef4444', label: 'CRITICAL' };
		case 'HIGH':
			return { className: 'border-amber-500 bg-amber-500/15 text-amber-400', hex: '#f59e0b', label: 'HIGH' };
		case 'MEDIUM':
			return {
